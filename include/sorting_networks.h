/*
 * File: sorting_networks.h
 * 
 * Source: https://github.com/jamesthomasgriffin/sorting_networks
 * Author: James Thomas Griffin
 * 
 * Description:
 * This header file provides a C++ template for generating small sorting networks
 * compatible with SIMD intrinsics. Sorting networks are branchless, operate on
 * sequences in-place, and require few registers, offering great performance for
 * sorting short sequences of simple types.
 * 
 * License: MIT License
 * 
 * Integration Date: 2024-12-02
 * 
 * Modification Notes:
 * - [Date]: [Description of modifications made]
 *   ...
 */
